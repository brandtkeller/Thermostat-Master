pipeline {
   ...
   environment {
         HOME_REPO = 'http://192.168.0.122:32600/brandtkeller/Thermostat-Master.git'
         GITHUB_REPO = 'github.com/brandtkeller/Thermostat-Master.git'
         REGISTRY = '192.168.0.128:5000/'
         IMAGE = ''
         PROJECT = 'Thermostat-Master'
    }
